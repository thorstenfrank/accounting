 ...
 *
 */
public class SendInvoiceCommand extends AbstractInvoiceCommand {

	/** Logger. */
	private static final Logger LOG = Logger.getLogger(SendInvoiceCommand.class);
	...
	protected void handleInvoice(Invoice invoice, ExecutionEvent event) throws ExecutionException {
		ModelHelper.sendInvoice(invoice);
	}
