...
/**
 * A callback interface for all clients using the {@link ExpenseEditingHelper}.
 * 
 * <p>
 ...
 *
 */
interface ExpenseEditingHelperCallback {
	...
	/**
	 * Called when a {@link Text} element needs to be created. The {@link ExpenseEditingHelper} may or may not apply
