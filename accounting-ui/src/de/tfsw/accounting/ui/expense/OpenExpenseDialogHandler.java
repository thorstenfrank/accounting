 ...
 *
 */
public class OpenExpenseDialogHandler extends AbstractAccountingHandler {

	private static final Logger LOG = LogManager.getLogger(OpenExpenseDialogHandler.class);
	...
	protected void doExecute(ExecutionEvent event) throws ExecutionException {
		ExpenseDialog dlg = new ExpenseDialog(getShell(event));
		dlg.open();
	}
