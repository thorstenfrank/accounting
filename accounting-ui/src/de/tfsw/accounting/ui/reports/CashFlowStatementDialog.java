 ...
 *
 */
public class CashFlowStatementDialog extends AbstractReportDialog {

	private static final String HELP_CONTEXT_ID = AccountingUI.PLUGIN_ID + ".CashFlowStatementDialog"; //$NON-NLS-1$
     ...
     * @param shell
     */
    protected CashFlowStatementDialog(Shell shell) {
    ...
    protected Control createDialogArea(Composite parent) {
    	getShell().setText(Messages.CashFlowStatementDialog_title);
    ...
    private void createOpexSection(Composite parent) {
		...
		formToolkit.paintBordersFor(section);
		section.setText(Messages.CashFlowStatementDialog_operatingExpenses);
    ...
    private void createTotalExpensesSection(Composite parent) {
		...
		section.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
		formToolkit.paintBordersFor(section);
		section.setText(Messages.CashFlowStatementDialog_totalExpenses);
    ...
    private void createProfitSection(Composite parent) {
		...
		section.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
		formToolkit.paintBordersFor(section);
		section.setText(Messages.CashFlowStatementDialog_Result);
		...
		formToolkit.createLabel(sectionClient, Messages.CashFlowStatementDialog_grossProfit); // gross profit
    ...
    private void createTaxSection(Composite parent) {
		...
		formToolkit.createLabel(sectionClient, Messages.CashFlowStatementDialog_outputTax);
		...
		formToolkit.createLabel(sectionClient, Messages.CashFlowStatementDialog_inputTax);
		...
		formToolkit.createLabel(sectionClient, Messages.CashFlowStatementDialog_sum);
	...
	private class IncomeStatementHandler implements ReportGenerationHandler {
        ...
        public String getTargetFileNameSuggestion() {
	        return ReportGenerationUtil.appendTimeFrameToFileNameSuggestion(
	        		Messages.CashFlowStatementDialog_fileNameSuggestion, incomeStatement.getTimeFrame());
        }
        ...
        public String getReportId() {
	        return "de.tfsw.accounting.reporting.CashFlowStatement";
        }
	}
}